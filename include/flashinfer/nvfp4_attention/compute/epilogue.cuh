...
#include "../utils/copy.cuh"  // sage::copy 函数

namespace sage {

using namespace cute;

// 显式引入 sage::copy 以避免与 cute::copy 冲突
template <bool Is_even_MN, bool Is_even_K, bool Clear_OOB_MN, bool Clear_OOB_K,
          typename TiledCopy, typename Engine0, typename Layout0, typename Engine1, typename Layout1,
          typename Engine2, typename Layout2, typename Engine3, typename Layout3>
CUTLASS_DEVICE void copy_with_bounds_check(
...
struct CollectiveEpilogueFwd{
...
#if defined(NON_WS)
    // Non-WS: all threads are compute threads (no producer WG to subtract)
    static constexpr int NumMmaThreads = kNThreads;
#else
    ...
    store_zero(
        ...
        copy_with_bounds_check</*Is_even_MN=*/false, /*Is_even_K=*/false, /*Clear_OOB_MN=*/false, /*Clear_OOB_K=*/false>(
