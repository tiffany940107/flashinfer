...
struct Flash_fwd_kernel_traits {
  ...
  static constexpr auto SFVectorSizeQK = 32;
  static constexpr int NumSFPV = kBlockN / 16;
  static constexpr auto SFVectorSizePV = 16;
  ...
  using ElementPV = cutlass::float_e2m1_t;
  using ElementSFPV = cutlass::float_ue4m3_t;
  ...
  using SmemCopyAtomKV = SmemCopyAtomK;
  ...
  using SmemCopyAtomSFPV = Copy_Atom<UniversalCopy<ElementSFPV>, ElementSFPV>;
  using SmemCopyAtomDS = Copy_Atom<UniversalCopy<ElementDS>, ElementDS>;


  using BlkScaledConfigQK =
      qk_mxfp8_pv_nvfp4_attention::BlockScaledConfig<SFVectorSizeQK>;
  using BlkScaledConfigPV =
      qk_mxfp8_pv_nvfp4_attention::BlockScaledConfig<SFVectorSizePV>;

  using BlkScaledConfig = BlkScaledConfigQK;
  using LayoutSF = typename BlkScaledConfigQK::LayoutSF;
  using LayoutSFPV = typename BlkScaledConfigPV::LayoutSF;
